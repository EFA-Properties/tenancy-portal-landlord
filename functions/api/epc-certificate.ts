...
<body>
  <div class="container">
    ...
    <div style="background:#1d1d1d;color:rgba(255,255,255,0.85);padding:8px 24px;border-radius:8px 8px 0 0;font-size:11px;text-align:center;">
      This page is generated by <strong style="color:white">Tenancy Portal</strong> (a commercial product by P3 Technologies) using open EPC data. This is not a government website.
    </div>
    ...
    <div class="footer">
      <p style="margin-bottom:4px"><strong>Tenancy Portal</strong> — a commercial product by P3 Technologies. This is not a government website.</p>
      <p>EPC data sourced from the open Energy Performance of Buildings Register API (England &amp; Wales).</p>
      <p>Certificate reference: ${escapeHtml(lmkKey)} · <a href="https://find-energy-certificate.service.gov.uk" target="_blank" rel="noopener noreferrer" style="color:#0f766e;">View official certificates on gov.uk</a></p>
    </div>
  </div>
</body>
</html>`
    ...
    return new Response(html, {
      headers: {
        ...
        'Content-Security-Policy': "default-src 'none'; style-src 'unsafe-inline'; script-src 'unsafe-inline'; img-src 'self' data:; font-src 'self'",
      },
    })
  } catch (err) {
